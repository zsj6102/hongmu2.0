...
import com.colpencil.redwood.present.mine.OrderDetailPresenter;
...
@ActivityFragmentInject(
        contentViewId = R.layout.activity_orderdetail
)
public class OrderDetailActivity  extends ColpencilActivity implements IOrderDetailView {
...
//    }
    ...
    @Override
    public void result(OrderDetailReturn orderDetailsReturn) {
