...
import static com.colpencil.redwood.R.id.tv_title;

@ActivityFragmentInject(
        contentViewId = R.layout.activity_speedshot)
/**
 * 速拍商区
 */ public class SpeedShotActivity extends ColpencilActivity implements IMeFragmentView {
    @Bind(R.id.ll_back)
    ...
    public void showLogin() {
        ...
        dialog.setListener(new DialogOnClickListener() {
            ...
            public void sureOnClick() {
                Intent intent = new Intent(SpeedShotActivity.this, LoginActivity.class);
    ...
    private void storeClick() {
        if (!SharedPreferencesUtil.getInstance(getApplication()).getBoolean(StringConfig.ISLOGIN, false)) {
            ...
            Intent intent = new Intent(SpeedShotActivity.this, BusinessActivity.class);
