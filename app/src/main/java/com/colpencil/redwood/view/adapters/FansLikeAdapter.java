...
public class FansLikeAdapter extends CommonAdapter<ItemStoreFans> {

    private  ComOnClickListener listener;
    public FansLikeAdapter(Context context, List<ItemStoreFans> mDatas, int itemLayoutId) {
        super(context, mDatas, itemLayoutId);
    }

    @Override
    public void convert(CommonViewHolder helper, ItemStoreFans item, final int position) {
